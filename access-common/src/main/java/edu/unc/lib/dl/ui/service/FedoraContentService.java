	...
	public void streamData(String pid, String datastream, boolean download, String gaCid, HttpServletResponse response) {
		...
		try {
			...
			if (datastreamResult.getDatastreamCategory() != null
				...
				analyticsTracker.trackEvent(gaCid, briefObject.getParentCollectionObject() == null ? "(no collection)"
						: briefObject.getParentCollectionObject().getDisplayValue(), "download", pid, null);
			}
